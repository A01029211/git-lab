...
const leftPaddle = new Paddle(new Vec(20, canvasHeight / 2), 20, 100, "white");
const rightPaddle = new Paddle(new Vec(canvasWidth - 40, canvasHeight / 2), 20, 100, "white");
const topBar = new GameObject(new Vec(0, 0), canvasWidth, 20, "white", "obstacle");
const bottomBar = new GameObject(new Vec(0, canvasHeight - 20), canvasWidth, 20, "white", "obstacle");
const leftGoal = new GameObject(new Vec(0, 0), 20, canvasHeight, "white", "leftGoal");
const rightGoal = new GameObject(new Vec(canvasWidth -20, 0), 20, canvasHeight, "white", "rightGoal");
